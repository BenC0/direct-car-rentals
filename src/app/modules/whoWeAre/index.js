            ...
            <div className={`${styles.WhoWeAreContent} content a-center j-center column`}>
                ...
                <div className={styles.WhoWeAreCopy}>
                    <p className={`${ptsans.className}`}>
                        At <b><u>Direct Car Hire</u></b>, we are a family run business, we are more than just a car rental service; we are your trusted travel companion, committed to enhancing your journey every step of the way. Our mission is to provide you with an unparalleled car rental experience that goes beyond simply handing you the keys. We believe that every road trip, business venture, or family vacation should be an unforgettable adventure, and we're here to make that happen. Here's what sets us apart and strengthens our bond with you, our valued customers: 
                    </p>
